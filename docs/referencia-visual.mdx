...
Guia de consistência para novos vídeos. Tudo aqui foi extraído dos vídeos gerados. Use como base para manter o padrão entre peças.

**Prompts:** [Prompts dos Vídeos](prompts)
...
<div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: "12px", marginBottom: "32px" }}>
  <div>
    <img src="/frames/v1_002.jpg" alt="Personagem — mão verde" style={{ width: "100%", borderRadius: "6px" }} />
    <p style={{ fontSize: "0.8rem", color: "var(--muted)", marginTop: "4px" }}>Mão verde — reflexo azulado noturno</p>
  </div>
  <div>
    <img src="/frames/v1_005.jpg" alt="Personagem — plano aberto" style={{ width: "100%", borderRadius: "6px" }} />
    <p style={{ fontSize: "0.8rem", color: "var(--muted)", marginTop: "4px" }}>Plano aberto final — tagline</p>
  </div>
  <div>
    <img src="/frames/v2_001.jpg" alt="Personagem — amanhecer" style={{ width: "100%", borderRadius: "6px" }} />
    <p style={{ fontSize: "0.8rem", color: "var(--muted)", marginTop: "4px" }}>Amanhecer — contraluz dourado</p>
  </div>
  <div>
    <img src="/frames/v2_003.jpg" alt="Personagem — janela" style={{ width: "100%", borderRadius: "6px" }} />
    <p style={{ fontSize: "0.8rem", color: "var(--muted)", marginTop: "4px" }}>Janela panorâmica — ambiente do quarto</p>
  </div>
</div>
